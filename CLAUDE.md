# coworkprojects — 我的專案工具總專案

## 對話開始時請先讀
進度與最近更動都在 Obsidian：`miao/coworkprojects/工作筆記.md`
...
## 工作桌 + 三個家
- 📋 GDrive 工作桌：`G:\我的雲端硬碟\coworkprojects\`（自動跨電腦同步）
- 🐙 GitHub repo：`miaoinmac/coworkprojects`（公開，網頁的家）
- 📘 Obsidian 駕駛艙：`miao/coworkprojects/工作筆記.md`（想法的家）
